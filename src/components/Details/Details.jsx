    ...
    <section className="Details" id="details">
      ...
      <div className="Details__text">
        ...
        <p>
          ...
          you. That could be flowers, cute critters, pastel swirls, etc.
        </p>
        ...
        <p className="Details__sub">
          ...
          the #baking-contest slack channel by EOD April 12th. There will be
          [TBD] categories and the winner of each will receive [TBD] perk
          points!
        </p>
